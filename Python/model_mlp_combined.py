#!/usr/bin/env python3
"""
model_mlp_combined.py

MLP on combined features — shape (N, 4*WINDOW-1=43):
    [I_window(11), Q_window(11), |s|_window(11), Δφ_window(10)]

Provides both I,Q amplitude context and rotation-invariant phase information.
...
Search space:
    hidden_dims : [(128,64), (128,64,32), (256,128,64), (256,128,64,32), (512,256,128)]
...
def run():
    print("\n" + "=" * 60)
    print("MLP-Combined  (I,Q + magnitude + differential phase)")
    print("=" * 60)
    ...
    final_val_ber, scaler = train_mlp(
        ...
        epochs=FINAL_EPOCHS, name="MLP-Combined", verbose=True)
    ...
    save_path = os.path.join(MODEL_DIR, "mlp_combined.pt")
    torch.save({
